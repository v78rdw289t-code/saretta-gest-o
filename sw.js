...
const CACHE_NAME = 'saretta-shell-v1.8.2';
...
const SHELL = [
  ...
  'assets/img/logo.svg',
  'assets/css/style.css?v=1.8.2',
  'assets/js/api.js?v=1.8.2',
  'assets/js/utils.js?v=1.8.2',
  'assets/js/home.js?v=1.8.2',
  'assets/js/os.js?v=1.8.2',
  'assets/js/financeiro.js?v=1.8.2',
  'assets/js/clientes.js?v=1.8.2',
  'assets/js/estoque.js?v=1.8.2',
  'assets/js/compras.js?v=1.8.2',
  'assets/js/fiado.js?v=1.8.2',
  'assets/js/insights.js?v=1.8.2',
  'assets/js/config.js?v=1.8.2',
  'assets/js/app.js?v=1.8.2',
];

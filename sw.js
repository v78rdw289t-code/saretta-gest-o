...
const CACHE_NAME = 'saretta-shell-v2.4.0';
...
const SHELL = [
  ...
  'assets/img/logo.svg',
  'assets/img/logo-app.png?v=2.4.0',
  'assets/css/style.css?v=2.4.0',
  'assets/js/api.js?v=2.4.0',
  'assets/js/utils.js?v=2.4.0',
  'assets/js/home.js?v=2.4.0',
  'assets/js/os.js?v=2.4.0',
  'assets/js/financeiro.js?v=2.4.0',
  'assets/js/clientes.js?v=2.4.0',
  'assets/js/estoque.js?v=2.4.0',
  'assets/js/compras.js?v=2.4.0',
  'assets/js/fiado.js?v=2.4.0',
  'assets/js/insights.js?v=2.4.0',
  'assets/js/config.js?v=2.4.0',
  'assets/js/lib/html2pdf.bundle.min.js',
  'assets/js/pdf.js?v=2.4.0',
